...
\end{align*}
where we've defined $$ \mm_i^{||} \triangleq \mm_i^T \hat \xx_i, \quad \mm_i^\perp \triangleq \mm_i - \mm_i^{||}$$ as the components of $\mm_i$ parallel and perpendicular to $\xx_i$.


Then, since $${D \over A} = -{4 b_i \over N \alpha^2 p_i^2} = -{4 N b_i \over N^2 \alpha^2 p_i^2}, \quad {BC \over 2 A^2} = -{4 \alpha p_i a_i \ka_i \over N \alpha^4 p_i^4} = {-4 a_i \ka_i \over N \alpha^3 p_i^3}, \quad {1 \over 8} \left({B \over A}\right)^3 = - {8 a_i^3 \over \alpha^3 N^3 p_i^3},$$ we get
\begin{align*}
